...
static WebDriver driver;
	...
	public static void main(String[] args) {
		...
		System.out.println(getWicketTakerName("Alyssa Healy"));

		System.out.println(getScoreCard("Dinesh Vrinda"));
		
		System.out.println(getScoreCard("Alyssa Healy"));
	...
	public static List<String> getScoreCard(String batsmanName) {
		List<WebElement> scoreEles = driver.findElements(By.xpath("//span[text()='"+batsmanName+"']//ancestor::td/following-sibling::td[contains(@class, 'ds-text-right')]"));
